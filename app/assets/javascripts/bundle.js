...
var author$project$Main$renderHeader = function (screen) {
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$text('← Back to Adventures')
								])),
							A2(
							elm$html$Html$h1,
							_List_Nil,
							_List_fromArray(
								[
									elm$html$Html$text(
									'Adventure ' + elm$core$String$fromInt(id))
								]))
						])),
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('set-size')
						]),
					_List_fromArray(
						[
							A2(
...
var author$project$Main$renderAdventureMap = F4(
	function (model, adventures, adventureId, locationIdx) {
		var maybeAdventure = A2(
			...
			function (a) {
				return _Utils_eq(a.id, adventureId);
			},
			adventures);
		if (maybeAdventure.$ === 'Just') {
			var adventure = maybeAdventure.a;
			var previousLocation = (locationIdx > 1) ? A2(
				elm$html$Html$a,
				_List_fromArray(
					[
						elm$html$Html$Attributes$href(
						'/adventures/' + (elm$core$String$fromInt(adventureId) + ('/locations/' + elm$core$String$fromInt(locationIdx - 1))))
					]),
				_List_fromArray(
					[
						A2(
			...
			return A2(
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$id('adventure-map-screen')
					]),
				_List_fromArray(
					[
						author$project$Main$renderHeader(model.screen),
						A2(
						elm$html$Html$div,
						_List_fromArray(
							[
...
var author$project$Main$renderFilters = A2(
	elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$text('Accessibility')
				]))
		]));
...
var author$project$Main$renderFooter = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm$html$Html$Attributes$href('https://github.com/timpaisley/gullivers'),
...
var author$project$Main$renderHomeScreen = function (adventures) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$renderHeader(author$project$Types$Home),
				author$project$Main$renderFilters,
...
var author$project$API$decodeNonempty = function (decoder) {
	return A2(
		elm$json$Json$Decode$andThen,
		author$project$API$maybeToDecoder('List was unexpectedly empty'),
		A2(
...
var author$project$API$decodeLocations = function () {
	...
	var decodeGeometry = A2(
		elm$json$Json$Decode$andThen,
		author$project$API$maybeToDecoder('Failed to decode geometry'),
		A2(
			elm$json$Json$Decode$map,
...
var author$project$API$adventuresRequest = function (token) {
	return elm$http$Http$request(
		{
			body: elm$http$Http$emptyBody,
			expect: elm$http$Http$expectJson(author$project$API$decodeAdventures),
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'location_id',
				elm$json$Json$Encode$int(location.id))
			]));
};
...
var author$project$API$visitLocationRequest = F2(
	function (token, location) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$jsonBody(
					author$project$API$encodeLocation(location)),
				expect: elm$http$Http$expectJson(
					elm$json$Json$Decode$succeed(_Utils_Tuple0)),
				headers: _List_fromArray(
					[
		...
		switch (msg.$) {
			...
			case 'VisitLocation':
				...
				return _Utils_Tuple2(
					...
					A2(
						elm$core$Platform$Cmd$map,
						author$project$Main$UpdateVisitResults,
						krisajenkins$remotedata$RemoteData$sendRequest(
