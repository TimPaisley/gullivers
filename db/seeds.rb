...
Adventure.create!(name: "Southern Walkway", image: "http://farm3.static.flickr.com/2652/3956961061_0fffc5a9c4.jpg", category: "path", description: "The Southern Walkway is an 11km walk along the Town Belt between Oriental Bay and Island Bay. The total walk can be completed in 4–5 hours depending on fitness. Although the walk is steep in places, it is not difficult overall and is suitable for those of average fitness.", locations: southernWalkwayLocations, badge_url: "", difficulty: "3", wheelchair_accessible: false)

Adventure.create!(name: "City to Sea Walkway", image: "http://farm3.static.flickr.com/2535/3866323429_b0d08ac097.jpg", category: "path", description: "The City to Sea Walkway starts in the heart of central Wellington near Parliament and ends at the south coast, 12km away in Island Bay. The walk takes about 6−7 hours but can be done in stages. To complete the entire walk in 1 day you will need a good level of fitness.", locations: southernWalkwayLocations, badge_url: "", difficulty: "4", wheelchair_accessible: false)

Adventure.create!(name: "Botanic Gardens", image: "https://www.rydges.com/accommodation/new-zealand/wellington/wp-content/uploads/sites/41/2015/10/960x330_Wellington-Botanic-Gardens-465x330.jpg", category: "path", description: "Choose between two walks: The 2.4 km Lookout Loop Walk, taking about 1.5 hours or the 1.0 km Salvation Bush Walk, taking about 45 minutes.", locations: southernWalkwayLocations, badge_url: "", difficulty: "1", wheelchair_accessible: true)

Adventure.create!(name: "Wellington Beaches", image: "https://static2.stuff.co.nz/1357637894/993/8155993.jpg", category: "path", description: "The Wellington City Council have installed a new type of walking experience on Mount Victoria that promotes time spent engaging in the natural environment and encourages families to explore our amazing outdoors.", locations: southernWalkwayLocations, badge_url: "", difficulty: "1", wheelchair_accessible: false)

Adventure.create!(name: "Heritage Week 2018", image: "https://services1.arcgis.com/CPYspmTk3abe6d7i/arcgis/rest/services/Heritage_week_virtual_tour/FeatureServer/0/13/attachments/27", category: "path", description: "Wellington Heritage Week is back for its second year, once again showcasing the history of the city with events, tours, exhibitions, and sneak peeks behind the scenes of some hidden treasures.", locations: southernWalkwayLocations, badge_url: "", difficulty: "2", wheelchair_accessible: true)
