...
Adventure.create!(name: "Southern Walkway", description: "The Southern Walkway is an 11km walk along the Town Belt between Oriental Bay and Island Bay. The total walk can be completed in 4–5 hours depending on fitness. Although the walk is steep in places, it is not difficult overall and is suitable for those of average fitness.", locations: allLocations, badge_url: "", difficulty: "3", wheelchair_accessible: false)

Adventure.create!(name: "City to Sea Walkway", description: "The City to Sea Walkway starts in the heart of central Wellington near Parliament and ends at the south coast, 12km away in Island Bay. The walk takes about 6−7 hours but can be done in stages. To complete the entire walk in 1 day you will need a good level of fitness.", locations: allLocations, badge_url: "", difficulty: "4", wheelchair_accessible: false)

Adventure.create!(name: "Wrights Hill Loops", description: "Choose between two walks: The 2.4 km Lookout Loop Walk, taking about 1.5 hours or the 1.0 km Salvation Bush Walk, taking about 45 minutes.", locations: allLocations, badge_url: "", difficulty: "2", wheelchair_accessible: true)

Adventure.create!(name: "Matairangi Nature Trail", description: "The Wellington City Council have installed a new type of walking experience on Mount Victoria that promotes time spent engaging in the natural environment and encourages families to explore our amazing outdoors.", locations: allLocations, badge_url: "", difficulty: "1", wheelchair_accessible: false)

Adventure.create!(name: "Brooklyn Turbine Trail", description: "Explore regenerating bush in Polhill Reserve and take in the best views of the city. This route is popular with mountain bikers, runners – and a healthy spillover of native birds from the nearby Zealandia sanctuary. ", locations: allLocations, badge_url: "", difficulty: "2", wheelchair_accessible: true)
