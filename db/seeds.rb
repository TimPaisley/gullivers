...
makaraPeak = Location.create!(geometry: "POINT(174.722247 -41.296912)", name: "Makara Peak", description: "If you're a biker then chances are you're already familiar with the world-class Makara Peak Mountain Bike Park. It features a 40-kilometre network of tracks, and the 4WD track is suitable for walking.", image_url: "https://upload.wikimedia.org/wikipedia/commons/2/22/Makara_Peak_Mountain_Bike_Park.JPG", reward: 10)
...
southernWalkway.adventure_locations.create!(location_id: makaraPeak.id)
